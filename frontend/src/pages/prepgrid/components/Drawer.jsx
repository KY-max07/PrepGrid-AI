...
const Drawer = ({ isOpen, onClose, title, children }) => {
  return (
    <div
      className={` fixed top-[79px] right-0 z-40 h-[calc(100dvh-64px)] p-4 overflow-y-auto transition-transform duration-300 ease-in-out  w-full md:w-[40vw]  shadow-2xl shadow-cyan-800/10 scrollbar-hidden border-l-gray-800 rounded bg-white  ${

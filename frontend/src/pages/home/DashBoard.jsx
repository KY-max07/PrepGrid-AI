  ...
  return (
    <DashBoardLayout>
      <div className="container mx-auto  bg-secondary">
          ...
          {sessions.length === 0 && (
            <div className="col-span-3 flex items-center justify-center gap-4 flex-col w-full h-[50vh]">
              ...
              <button
                ...
                className="bg-linear bg-amber-200 px-4 cursor-pointer rounded-full hover:bg-amber-300 transition-colors duration-300 ease-in-out text-neutral-950"
              >
                Create New Session
              </button>
            </div>
        ...
        <button
          onClick={() => setOpenCreateModal(true)}
          class="fixed md:bottom-10 md:right-10 bottom-2 right-2 inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group bg-neutral-950 text-sm md:text-md cursor-pointer"
        >

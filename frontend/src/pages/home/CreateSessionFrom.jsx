...
const CreateSessionForm = () => {
  ...
  return (
    <div className="w-[90vw] md:w-[35vw] p-4  rounded-lg shadow-md text-white ">
      <h3 className="text-3xl font-bold mb-4 text-center text-black/80">
        Start a New Interview Journey
      </h3>
      <p className="text-gray-800 mb-6 text-center text-xs pb-10">
      ...
      <form onSubmit={handleCreateSession} className="space-y-4 flex-col flex ">
        ...
        <button
          type="submit"
          className="w-full cursor-pointer bg-neutral-700 hover:bg-neutral-950 text-white font-bold py-2 px-4 rounded-md focus:outline-none   disabled:cursor-not-allowed transition duration-300 flex items-center justify-center gap-2"
          disabled={isLoading}
        >
